...
(function ($) {
  'use strict';
	...
	$.sceditor.locale["pl"] = {
		...
		"Cut": "Wytnij",
		"Your browser does not allow the cut command. Please use the keyboard shortcut Ctrl/Cmd-X": "Twoja przeglądarka nie obsługuje opcji wycinania. Użyj skrótu klawiszowego ctrl + x",
		"Copy": "Skopiuj",
		"Your browser does not allow the copy command. Please use the keyboard shortcut Ctrl/Cmd-C": "Twoja przeglądarka nie obsługuje opcji kopiowania. Użyj skrótu klawiszowego ctrl + c",
		"Paste": "Wklej",
		"Your browser does not allow the paste command. Please use the keyboard shortcut Ctrl/Cmd-V": "Twoja przeglądarka nie obsługuje opcji wklejania. Użyj skrótu klawiszowego ctrl + v",
		...
		"Code": "Kod",
		"Width (optional):": "Szerokość (opcja)",
		"Height (optional):": "Wysokość (opcja)",
