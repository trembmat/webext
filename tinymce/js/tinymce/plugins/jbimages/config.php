...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/challengehivernal2014/images'; // Relative to domain name
	$config['upload_path'] = "/home/shared/www/demo.serveurwebquebec.com/challengehivernal2014/images"; //$_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
