...
$upload_dir = $_SESSION['RFM_UPLOAD_DIR']; // path from base_url to base of upload folder (with start and final /)
$current_path = $_SESSION['RFM_REL_PATH']; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $_SESSION['RFM_REL_THUMBS']; // relative path from filemanager folder to thumbs folder (with final /)
